...
def downgrade() -> None:
    ...
    op.drop_table('creator_post_saves')
    op.drop_table('creator_post_media')
    op.drop_table('creator_post_likes')
    op.drop_table('creator_post_hashtags')
    op.drop_table('creator_post_comments')
    op.drop_table('creator_post_category_tags')
    op.drop_table('reference_category_tags')
    op.drop_table('personal_post_likes')
    op.drop_table('perosnal_post_media')
    op.drop_table('perosnal_post_comments')
